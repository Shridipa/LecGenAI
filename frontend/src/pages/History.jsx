      ...
      <main className="max-w-7xl mx-auto px-6 py-12 relative z-10">
        {!user ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-2xl font-bold mb-4 tracking-tight text-main">Private History</h2>
            <p className="text-secondary text-sm mb-8 max-w-xs mx-auto leading-relaxed">
              Please sign in to view and manage your generated lecture materials and study progress.
            </p>
            <Link 
              to="/login"
              className="btn-gradient px-10 py-3 rounded-xl text-xs font-bold uppercase tracking-widest shadow-lg shadow-primary/20"
            >
              Sign In Now
            </Link>
          </div>
