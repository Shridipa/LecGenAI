...
- **Premium Visual Reference:** [http://localhost:8000/api-reference](http://localhost:8000/api-reference) (Highly Recommended)
- **Interactive Swagger UI:** [http://localhost:8000/docs](http://localhost:8000/docs)
- **ReDoc Technical Manual:** [http://localhost:8000/redoc](http://localhost:8000/redoc)

For a detailed list of endpoints and technical details, see [API_DOCUMENTATION.md](./API_DOCUMENTATION.md).
